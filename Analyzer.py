...
numeric=[c for c in df.select_dtypes(include=np.number).columns if "id" not in c.lower()]
...
elements=[]
elements.append(Paragraph("Logging & Monitoring Analytics Report",title_style))

summary_text=f"""
Dataset: {INPUT_FILE}<br/>
